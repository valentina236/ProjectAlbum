...
namespace DatabaseAlbum
{
    ...
    public class RJComboBox : UserControl
    {
        ...
        public RJComboBox()
        {
            ...
            cmbList.DropDownClosed += new EventHandler(cmbList_DropDownClosed);
        ...
        public string GetItemText(int index)
        {
            ...
            {
                object item = cmbList.Items[index];
                string text = item.ToString(); // Или здесь используйте логику для получения текста из объекта элемента
                return text;
            }
            return string.Empty;
        }
        ...
        // Добавляем событие SelectionChangeCommitted
        public event EventHandler SelectionChangeCommitted;

        // Метод ComboBox_SelectionChangeCommitted вызывается при изменении выбранного элемента
        private void ComboBox_SelectionChangeCommitted(object sender, EventArgs e)
        {
            // Проверяем, подписаны ли обработчики события, прежде чем вызывать его
